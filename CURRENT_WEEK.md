...
- 상세 학습 본문: [week08-rag-evaluation/README.md](week08-rag-evaluation/README.md)
- 기본 작업 폴더(CWD): [`week08-rag-evaluation/rag_lab`](week08-rag-evaluation/rag_lab/)
- 결과와 기록: 주차 README에서 지정한 파일 또는 기존 학습 노트
- 개인 기록: `week08-rag-evaluation/.local/` (Git 제외)
