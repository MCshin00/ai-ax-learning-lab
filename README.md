...
각 주차의 해설은 원리·구체 사례·설계 이유·한계를 실제 실습과 연결합니다. 기본 개념을 읽고 도구를 사용한 뒤, 해당 단계의 해설과 자신의 결과를 대조하세요. 글을 쓰고 싶다면 확인한 사실과 해석을 구분해 설명하며, 도구를 처음부터 구현하거나 매주 별도 글을 제출할 필요는 없습니다.
