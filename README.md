...
초안·코드·기준 문장은 AI의 도움으로 만들어도 됩니다. 학습자는 목적·범위·기대 결과를 검토하고 실제 결과의 수용 여부를 판단합니다. 각 주차는 먼저 도구를 실행하고 결과와 관련된 구조를 읽습니다.
...
진도는 실제로 실행·확인한 내용으로 판단합니다. 이미 쓴 초안을 버릴 필요는 없습니다. 2주차 Skill 초안이 있다면 주차 README의 이어가기 절에서 Creator 수정 실습부터 시작할 수 있습니다.
